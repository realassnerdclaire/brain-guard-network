          ...
          >
            ...
            <div className="container relative z-10 text-center px-4 sm:px-6">
              <div className="max-w-6xl mx-auto">
                ...
                <div className="space-y-4 md:space-y-4 text-left max-w-4xl mx-auto">
                  <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 border border-purple-500/40 rounded-2xl p-4 md:p-4 animate-scale-in hover:scale-105 transition-all duration-500" style={{animationDelay: '0.2s'}}>
                    ...
                    <p className="text-base md:text-base text-white/90 leading-relaxed mb-2 md:mb-2">
                      The market is scaling fast — <span className="text-pink-300 font-semibold bg-purple-600/20 px-2 py-1 rounded animate-pulse">3M+ EEG devices expected in North America by 2026</span>.
                    </p>
                    <div className="flex items-center gap-2 text-sm md:text-sm text-purple-300 font-semibold">
                  ...
                  <div className="bg-black/40 border border-white/10 rounded-2xl p-4 md:p-4 animate-fade-in" style={{animationDelay: '0.4s'}}>
                    ...
                    <div className="space-y-3 md:space-y-2">
                      <div className="border-l-4 border-blue-400 pl-3 md:pl-4 bg-blue-500/15 p-2 md:p-2 rounded-r-lg hover:bg-blue-500/25 transition-all duration-300 hover-scale">
                      ...
                      <div className="border-l-4 border-purple-400 pl-3 md:pl-4 bg-purple-500/15 p-2 md:p-2 rounded-r-lg hover:bg-purple-500/25 transition-all duration-300 hover-scale">
                        <div className="flex items-center gap-2 md:gap-2 mb-1 md:mb-1">
                          <span className="text-lg md:text-lg"></span>
                      ...
                      <div className="border-l-4 border-pink-400 pl-3 md:pl-4 bg-pink-500/15 p-2 md:p-2 rounded-r-lg hover:bg-pink-500/25 transition-all duration-300 hover-scale">
                        <div className="flex items-center gap-2 md:gap-2 mb-1 md:mb-1">
                          <span className="text-lg md:text-lg"></span>
                  ...
                  <div className="bg-purple-900/25 border border-pink-400/30 rounded-2xl p-4 md:p-4 text-center animate-scale-in relative overflow-hidden" style={{animationDelay: '0.6s'}}>
                    <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-pink-500/5 animate-pulse"></div>
                    <div className="relative z-10">
                      ...
                      <p className="text-base md:text-base text-white font-semibold">
                        Companies that wait risk being <span className="text-white bg-purple-500/30 px-2 md:px-2 py-1 rounded-lg animate-pulse sparkle">locked out</span> of clinical and consumer markets.
                      </p>
                    </div>
                  </div>
                </div>
