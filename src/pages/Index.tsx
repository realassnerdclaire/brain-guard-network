              ...
              >
                <defs>
                  <linearGradient id="problemFlow1" x1="0%" y1="0%" x2="100%" y2="0%">
                    ...
                    <stop offset="50%" style={{stopColor: '#6C63FF', stopOpacity: 0.3}} />
                    <stop offset="100%" style={{stopColor: '#4F46E5', stopOpacity: 0.2}} />
                  </linearGradient>
                  <linearGradient id="problemFlow2" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" style={{stopColor: '#A855F7', stopOpacity: 0.15}} />
                    <stop offset="50%" style={{stopColor: '#7C3AED', stopOpacity: 0.25}} />
                    <stop offset="100%" style={{stopColor: '#A855F7', stopOpacity: 0.15}} />
                  </linearGradient>
                </defs>
                ...
                <path
                  ...
                  opacity="0.2"
                  style={{
                    animation: 'problemFlow 20s linear infinite reverse'
                  }}
                />
                ...
                <path
                  ...
                  opacity="0.15"
                  style={{
                    animation: 'problemFlow 25s linear infinite'
                  }}
                />
