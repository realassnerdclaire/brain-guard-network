    ...
    <section id="how" className="border-t bg-muted/40">
      <div className="container py-16 md:py-16">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-semibold sm:text-4xl md:text-3xl lg:text-4xl">How it works</h2>
          <p className="mt-3 text-muted-foreground">A thin but unbreakable layer between headsets and apps.</p>
        </div>
        <div className="mt-10 md:mt-8 grid gap-6 md:gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {STEPS.map(({ title, description, Icon }) => (
            <article key={title} className="rounded-xl border bg-card p-6 md:p-5 shadow-elegant">
