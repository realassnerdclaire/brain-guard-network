...
const FeatureCards = () => {
  return (
    <section id="features" className="container py-20 md:py-12 lg:py-16 px-6 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-4xl text-center">
        <h2 className="text-3xl font-semibold sm:text-4xl md:text-3xl lg:text-3xl">Security baked into the signal flow</h2>
        <p className="mt-3 text-muted-foreground">
          We don't decode thoughts—we defend them. XBrainer turns raw brainwaves into a trusted asset.
        </p>
      </div>
      <div className="mt-16 md:mt-8 grid gap-8 md:gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
        {FEATURES.map(({ title, description, Icon }) => (
          <article key={title} className="rounded-xl border bg-card p-8 md:p-4 lg:p-6 shadow-elegant hover-scale">
