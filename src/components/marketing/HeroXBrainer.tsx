    ...
    <section className="relative min-h-screen bg-background overflow-hidden flex flex-col justify-center sm:justify-start">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        <svg className="w-full h-full opacity-30" viewBox="0 0 1920 1080" preserveAspectRatio="xMidYMid slice">
          ...
          {/* Simplified flowing EEG patterns */}
          <path d="M0,300 Q480,280 960,300 T1920,300"
          ...
          <path d="M0,500 Q240,520 480,500 Q720,480 960,500 Q1200,520 1440,500 Q1680,480 1920,500"
          ...
          <path d="M0,700 Q320,680 640,700 Q960,720 1280,700 Q1600,680 1920,700"
                stroke="url(#eegGradient)" 
                strokeWidth="1" 
                fill="none" 
                style={{
